...
final_dB_by_distance = np.clip(initial_dB - (attenuation_distance + total_attenuation_obstacles), 0, None) #max(0.0, initial_dB - (attenuation_distance + total_attenuation_obstacles))
